...
bucket_name = 'jm-school-project-s3'
prefix = 'warehouse/'
...
Mark_node1704390766767 = glueContext.create_dynamic_frame.from_options(
    ...
    format="csv",
    connection_options={
        "paths": ["s3://jm-school-project-s3/staging_layer/mark/"],
        "recurse": True,
    },
...
Student_node1704390766920 = glueContext.create_dynamic_frame.from_options(
    ...
    format="csv",
    connection_options={
        "paths": ["s3://jm-school-project-s3/staging_layer/student/"],
        "recurse": True,
    },
...
DW_node1704390869493 = glueContext.create_dynamic_frame.from_options(
    ...
    format="csv",
    connection_options={
        "paths": ["s3://jm-school-project-s3/warehouse/"],
        "recurse": True,
    },
...
AmazonS3_node1704390958322 = glueContext.write_dynamic_frame.from_options(
    ...
    format="glueparquet",
    connection_options={
        "path": "s3://jm-school-project-s3/warehouse/",
        "partitionKeys": [],
    },
